...
#
	...
	def collision(self, objPos:Vector2, groundType:str):
		...
		if groundType == "Ice":
			pass
		elif groundType == "trampoline":
			pass
		elif groundType == "Moveblock":
			pass
	...
	def update(self,type):
			...
			if self.isOnGround == True:
				if self.vel.y >= 14:
					...
					if nothingDoing == len(self.pressed):
						self.whatdoing = "stand"
				self.hitbox.bottom = int(self.objPos.y)
				self.vel.y = 0
		...
		if type == 3:
			#self.hitbox = Rect(self.hitbox.left+5, self.hitbox.bottom+15, self.frameWidth-5, self.frameHeight-15)
			self.hitbox.update(self.hitbox.left, self.hitbox.top, self.frameWidth-5, self.frameHeight-15)
	...
	def actions(self):
		...
		if self.whatdoing == "squat":
			...
			self.hitbox.update(self.hitbox.left,self.hitbox.top+15,self.hitbox.width,self.hitbox.height-15)
	...
	def draw(self):
		...
		if self.whatdoing == "jump" or self.whatdoing == "leap":
			screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-15), (self.frameWidth*3, self.RowNum*self.frameHeight, self.frameWidth, self.frameHeight))
		elif self.whatdoing == "stand":
			screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-15), (self.frameWidth*self.standFrame[self.frameNum], self.RowNum*self.frameHeight, self.frameWidth, self.frameHeight))
		elif self.whatdoing == "walk":
			screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-15), (self.frameWidth*self.walkFrame[self.frameNum], self.RowNum*self.frameHeight, self.frameWidth, self.frameHeight))
		elif self.whatdoing == "sprint":
			screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-15), (self.frameWidth*self.sprintFrame[self.frameNum], self.RowNum*self.frameHeight, self.frameWidth, self.frameHeight))
		elif self.whatdoing == "land":
			screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-15), (self.frameWidth*self.direction, 2*self.frameHeight, self.frameWidth, self.frameHeight))
		elif self.whatdoing == "crawl":
			screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-30), (self.frameWidth*self.crawlFrame[self.frameNum], self.RowNum*self.frameHeight, self.frameWidth, self.frameHeight))
		elif self.whatdoing == "squat":
			screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-30), (self.frameWidth, self.RowNum*self.frameHeight, self.frameWidth, self.frameHeight))
		#elif self.whatdoing == "chirp":
		#	screen.blit(self.possum, (self.hitbox.left, self.hitbox.top-15), (2*self.frameWidth, self.RowNum*self.frameHeight, self.frameWidth, self.frameHeight))
		else:
			self.whatdoing = "walk"
